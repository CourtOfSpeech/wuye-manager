...
<el-input v-model="searchMap.type" placeholder="类型，1：投诉、2：表扬、3：建议"></el-input></el-form-item>
          <el-form-item label="内容">
<el-input v-model="searchMap.content" placeholder="内容"></el-input></el-form-item>
          <el-form-item label="反馈时间">
<el-input v-model="searchMap.backtime" placeholder="反馈时间"></el-input></el-form-item>
...
<el-input v-model="searchMap.username" placeholder="反馈人姓名"></el-input></el-form-item>
...
<el-input v-model="searchMap.mobile" placeholder="手机号"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="backtime" label="反馈时间" width="80"></el-table-column>
          <el-table-column prop="handletime" label="处理时间" width="80"></el-table-column>
          <el-table-column prop="state" label="状态" width="80"></el-table-column>
          <el-table-column prop="username" label="反馈人姓名" width="80"></el-table-column>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        <el-form-item label="类型"><el-input placeholder="类型，1：投诉、2：表扬、3：建议" v-model="pojo.type"></el-input></el-form-item>
...
export default {
  ...
  methods: {
    fetchData() {
      feedbackApi.search(this.currentPage, this.pageSize, this.searchMap).then(response => {
        this.list = response.data.rows
        this.total = response.data.total
      })
    },
    handleSave() {
      feedbackApi.update(this.id, this.pojo).then(response => {
        this.$message({
    ...
    handleEdit(id) {
      ...
      if (id !== '') { // 修改
        feedbackApi.findById(id).then(response => {
          if (response.flag) {
    ...
    handleDelete(id) {
      this.$confirm('确定要删除此纪录吗?', '提示', {
        ...
        feedbackApi.deleteById(id).then(response => {
